...
namespace RpgApi.Data
{
    public class DataContext : DbContext // DBContext é a herança do BD
    {
        ...
        public DbSet<Arma> TB_ARMAS { get; set; } // Nome para utilizar no codigo

        public DbSet<Usuario> TB_USUARIOS { get; set; } // Nome para utilizar no codigo

        public DbSet<Disputa> TB_DISPUTAS{get; set; }
        public DbSet<Habilidade> TB_HABILIDADES { get; set; } // Nome para utilizar no codigo
         public DbSet<PersonagemHabilidade> TB_PERSONAGENS_HABILIDADES { get; set; } // Nome para utilizar no codigo

        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Personagem>().ToTable("TB_PERSONAGENS"); //nome para chamar no banco de dados
            modelBuilder.Entity<Arma>().ToTable("TB_ARMAS");//nome para chamar no banco de dados
            modelBuilder.Entity<Usuario>().ToTable("TB_USUARIOS"); //nome para chamar no banco de dados
            modelBuilder.Entity<Habilidade>().ToTable("TB_HABILIDADES"); //nome para chamar no banco de dados
            modelBuilder.Entity<PersonagemHabilidade>().ToTable("TB_PERSONAGENS_HABILIDADES"); //nome para chamar no banco de dados
            ...
            (
                ...
                new Arma() { Id = 1, Nome = "Adaga", Dano = 10, PersonagemId = 1 },
                new Arma() { Id = 2, Nome = "Arco", Dano = 18,PersonagemId = 2 },
                new Arma() { Id = 3, Nome = "Cajado", Dano = 10, PersonagemId = 3},
                new Arma() { Id = 4, Nome = "Espada", Dano = 15 ,PersonagemId = 4},
                new Arma() { Id = 5, Nome = "Lança", Dano = 12, PersonagemId = 5},
                new Arma() { Id = 6, Nome = "Mangal", Dano = 12, PersonagemId = 6 },
                new Arma() { Id = 7, Nome = "Mao", Dano = 8 ,PersonagemId = 7 }
            );
            ...
            modelBuilder.Entity<Usuario>()
             ...
             //Relacionamento de One to One (um para um)   
            ...
            //Inicio de criação do usuario padrão
            ...
            user.Latitude = 23.52002241;
            user.Longitude = 46.594498;
